    ...
    <div className="page-wrapper">
      ...
      <section className="relative py-16 sm:py-20 overflow-hidden">
        ...
        <div className="section-container text-center relative z-10" ref={heroRef}>
          <p className="font-body text-sm font-bold text-secondary uppercase tracking-widest mb-3">What We Offer</p>
          <h1 className="section-title text-primary-foreground mb-4">Our Services & Collection</h1>
          <p className="section-subtitle text-primary-foreground/65">Explore our wide range of indoor plants, fresh flowers, and expert gardening guidance.</p>
        </div>
      </section>
