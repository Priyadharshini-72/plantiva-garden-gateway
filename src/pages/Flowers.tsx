    ...
    <section className="py-16 sm:py-24 bg-background min-h-screen">
      <div className="section-container" ref={ref}>
        <div className="text-center mb-14">
          <p className="font-body text-sm font-semibold text-primary uppercase tracking-widest mb-3">Collection</p>
          <h1 className="section-title">Beautiful Flowers</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {flowers.map((flower) => (
            <div key={flower.name} className="plant-card group cursor-pointer">
